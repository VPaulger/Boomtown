...
//           const items = data.items.map(({ title, description, borrower }) => (
//             <Grid item>
...
const Borrowing = () => {   
  ...
  return(
    <div className={classes.itemContainer} style={{justifyContent: 'center'}}>
      <div className={classes.title}>
        <h2>Library:</h2>
      </div>
      <Grid container spacing={16} className={classes.grid}>
          ...
          const items = data.items.map(({ title, description, borrower }) => (
              <Grid item>
                <Card className={classes.card} style={{background: borrower ? '#D62426' : '#FFFFFF'}}>
                  ...
                  <CardActions>
                    <BorrowItemButton className={classes.borrowButton}/>
                  </CardActions>
                </Card>
              </Grid>
            ));
